...
stack_error stack_assert(stack_struct* stack) {
    ...
    uint32_t expected_data_hash = murmurhash_32((const uint8_t*)stack->data, (size_t)stack->number_of_elems);
...
static void_sex hash_update(stack_struct* stack) {
    stack->struct_hash = 0;
    stack->data_hash =   0;
    stack->data_hash =   murmurhash_32((const uint8_t*)stack->data, (size_t)stack->number_of_elems);
